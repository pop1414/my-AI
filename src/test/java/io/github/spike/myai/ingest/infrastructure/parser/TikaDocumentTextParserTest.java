...
class TikaDocumentTextParserTest {
    ...
    void parse_shouldReturnCleanedText() {
        ...
        TikaDocumentTextParser parser = new TikaDocumentTextParser(cleaningService, 2000, false);
        String raw = """
                姓名：张三
                image1.jpeg
                技术栈：Java
    ...
    void parse_shouldThrowException_whenExceedMaxTextLength() {
        TextCleaningService cleaningService = new TextCleaningService();
        TikaDocumentTextParser parser = new TikaDocumentTextParser(cleaningService, 20, false);
