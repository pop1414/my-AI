...
_最后更新: 2026-06-19 | 扫描模式: 深度扫描（源码级提取） | 端点总数: 34_

> **Docling 集成说明**: 文档解析已从 Apache Tika 迁移至 Docling Serve（通过 `arconia-docling-spring-boot-starter`），此变更为内部实现变更，不影响 API 契约。
