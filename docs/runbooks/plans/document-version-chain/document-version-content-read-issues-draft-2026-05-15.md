...
- #22 完成后，#23、#24、#25 应收敛到同一个后端正文读取 endpoint：`GET /api/v1/documents/{documentId}/content`，并分别补齐 `source=LATEST`、`source=ASKABLE_BASELINE`、`source=EXPLICIT_VERSION&versionNumber=...` 三种语义。
